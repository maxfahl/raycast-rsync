...
export default [
  ...
  { name: 'no-OPTION', description: 'turn off an implied OPTION (e.g. --no-D)' },
  ...
  { name: 'help', description: 'show this help (see below for -h comment)' },
  { name: 'daemon', description: 'run as an rsync daemon' },
  { name: 'address', param: 'ADDRESS', description: 'bind to the specified address' },
  { name: 'bwlimit', param: 'KBPS', description: 'limit I/O bandwidth; KBytes per second' },
  ...
  { name: 'port', param: 'PORT', description: 'listen on alternate port number' },
  { name: 'log-file', param: 'FILE', description: 'override the "log file" setting' },
  { name: 'log-file-format', param: 'FMT', description: 'override the "log format" setting' },
  { name: 'sockopts', param: 'OPTIONS', description: 'specify custom TCP options' },
  { name: 'verbose', description: 'increase verbosity' },
  { name: 'ipv4', description: 'prefer IPv4' },
  { name: 'ipv6', description: 'prefer IPv6' },
  { name: 'help', description: 'show this help (if used after --daemon)' },
] as RsyncOption[]
